...
## Note
This code is not for download and is only purposed for a private Discord server.
The only reason I'm committing to GitHub is for easy access as a portfolio project.
